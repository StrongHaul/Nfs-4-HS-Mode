    ...
    items: list[int | str | tuple[str, str, str, str]] = [
        ...
        *(
            [
                ...
                bne("t1", "zero", "finish"),
                nop(),
                # Hot Pursuit + enabled traffic cheat: keep up to two traffic
                # cars active on night variants without changing carData setup.
        ...
        "single_race",
        # Single Race + enabled traffic cheat: let roving traffic keep up to
        # the normal day cap even on night/dusk variants.
        slti("t1", "v0", MIN_SINGLE_RACE_TRAFFIC_CAP),
        beq("t1", "zero", "finish"),
        nop(),
        addiu("v0", "zero", MIN_SINGLE_RACE_TRAFFIC_CAP),
