...
git       8c00013 Use code-immediate cheat gate for civilian blinking
```

Проверено пользователем после добавления code-immediate gate для моргания обычных машин: зависаний не наблюдается, фары/поворотники/белые задние огни работают, полицейские спичи через громкоговоритель работают.
