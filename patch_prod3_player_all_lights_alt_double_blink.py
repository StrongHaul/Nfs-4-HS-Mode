...
BACKUP_SUFFIX = ".orig_before_prod3_player_all_lights_alt_double_blink_v3"
...
def make_cave() -> bytes:
    items: list[int | str | tuple[str, str, str, str]] = [
        ...
        bne("t1", "zero", "done"),
        nop(),
        # Player car only; do not touch AI racers, traffic, or cops.
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="PROD3: player-only final DrawC mask pass for alternating double blink."
    )
    ...
    print("no cheat gate; AI/cops/traffic are not touched")
    return 0
